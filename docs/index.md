...
dependency to fall back on. [Evidence, opacity and verdicts](decisions/opacity.md) says
what both cost.
...
`OPAQUE`, not clean. [Determinism and the Python layer](decisions/interpreter.md) records
